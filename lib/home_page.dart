    ...
    return Consumer<ProgressProvider>(
      builder: (context, progressProvider, child) {
        ...
        return Card(
          ...
          child: ExpansionTile(
            leading: Icon(mealIcon, color: Colors.teal),
    ...
    return Consumer<ProgressProvider>(
      builder: (context, progressProvider, child) {
        return Card(
          ...
          child: ListTile(
            leading:
                const Icon(Icons.track_changes, color: Colors.teal, size: 40),
            title: const Text(
              "Track Your Progress",
              style: TextStyle(
                  fontSize: 16,
      ...
      children: [
        Positioned(
          ...
          child: ClipPath(
            clipper: WaveClipper(),
            child: Container(
                height: 100, color: const Color(0xFF008080).withOpacity(0.3)),
          ),
        ),
        Positioned(
          bottom: 30,
          ...
          child: ClipPath(
            clipper: WaveClipper(),
            child: Container(
                height: 80, color: const Color(0xFF008080).withOpacity(0.5)),
          ),
        ),
        Positioned(
  ...
  showDialog(
    ...
    builder: (context) {
      return AlertDialog(
        ...
        content: const Text(
            'For inquiries, please email us at ettizanapp@gmail.com.'),
        actions: [
          TextButton(
              onPressed: () => Navigator.of(context).pop(),
